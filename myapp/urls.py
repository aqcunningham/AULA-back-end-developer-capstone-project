...
from . import views
from .views import MenuListCreateView, BookingListCreateView, UserCommentListCreateView, BookingAPIView, BookingViewSet,SingleMenuItemView, UserViewSet, StaffUserView, add_menu_view, menu_items_view
...
urlpatterns = [
	...
	path('reviews/', views.form_view, name='form_view'),
	# editable menu items:
	path('add_menu_items/', views.add_menu_view, name='add_menu_view'),
	path('menu_items/', views.menu_items_view, name='menu_view'),
	path('makereservation/', views.book, name="book"),

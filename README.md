...
# By default, new accounts have no special permissions. To test manager vs. waiter behavior, log into /admin/ with your superuser account, create two Groups named "managers" and "waiters," and assign your test account to one.
# Reservations management (staff only)
http://127.0.0.1:8000/make_reservation/staff/
# View, edit, and delete reservations. Only accounts in the "managers" group can delete; "waiters" can view/create/edit only.
